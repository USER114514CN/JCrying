...
public class Rc2Encryptor extends GeneralEncryptor {
    private static final String TRANSFORM = "RC2/CBC/PKCS5Padding";
    ...
    public byte[] encrypt(byte[] data, byte[] key) {
        ...
        if (key.length < MIN_KEY_LEN || key.length > MAX_KEY_LEN) {
            throw new IllegalArgumentException("RC2密钥长度范围：5 ~ 16 字节");
        }
        ...
        try {
            ...
            throw new IllegalStateException("RC2加密发生异常", e);
        }
    }
